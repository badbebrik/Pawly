const chatLocalMessageIdPrefix = 'local-';
  ...
  ChatListItem copyWith({
    ...
    return ChatListItem(
      ...
      otherUserLastReadMessageId:
          otherUserLastReadMessageId ?? this.otherUserLastReadMessageId,
...
class ChatMessageItem {
  ...
  bool get isLocal => messageId.startsWith(chatLocalMessageIdPrefix);
