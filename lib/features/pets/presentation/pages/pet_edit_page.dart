              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  _ModeToggle(
                    title: 'Порода',
                    mode: _breedMode,
                    onChanged: (value) => setState(() => _breedMode = value),
                  ),
                  const SizedBox(height: PawlySpacing.sm),
                  ...
                  _ModeToggle(
                    title: 'Паттерн',
                    mode: _patternMode,
                    onChanged: (value) => setState(() => _patternMode = value),
                  ),
                  const SizedBox(height: PawlySpacing.sm),
                  if (_patternMode == _CatalogPickMode.catalog)
                    DropdownButtonFormField<String>(
                      value: _patternId,
                      decoration: const InputDecoration(labelText: 'Паттерн'),
                      items: data.catalog.patterns
                          ...
                          .toList(growable: false),
                      onChanged: (value) => setState(() => _patternId = value),
                      validator: (value) {
                        if (_patternMode == _CatalogPickMode.catalog &&
                            (value == null || value.isEmpty)) {
                  ...
                  _DateButton(
                    ...
                    onTap: () => _pickDate(
                      ...
                      lastDate: DateTime.now(),
                      onPicked: (value) =>
                          setState(() => _microchipInstalledAt = value),
                    ),
                  ),
